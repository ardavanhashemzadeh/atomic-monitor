...
def check_tables(logging, con, cur):
	try:
...
def insert_log_data(logging, cur, con, server_name, typ, message):
    try:
...
# insert new ping data to SQL database
def insert_ping_data(logging, cur, con, server_id, status, ping=None):
    try:
...
def insert_memory_data(logging, cur, con, server_id, status, ram_percent=None, ram_used=None, ram_total=None, swap_percent=None,
...
def insert_cpu_data(logging, cur, con, server_id, status, cpu_percent=None):
    try:
...
def insert_net_data(logging, cur, con, server_id, status, name=None, sent=None, received=None):
    try:
...
# insert new network data to SQL database
def insert_load_data(logging, cur, con, server_id, status, one_avg=None, five_avg=None, fifteen_avg=None):
    try:
...
def insert_disk_data(logging, cur, con, server_id, status, device=None, percent=None, used=None, total=None):
    try:
...
def insert_disk_io_data(logging, cur, con, server_id, status, io=None):
    try:
